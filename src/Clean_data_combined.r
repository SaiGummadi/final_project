...
library(lubridate)
library(readr)
df1 <- read.csv("C:/Users/DELL/Documents/818_Project-main/data_raw/US_Accidents_Dec21_updated.csv", stringsAsFactors = FALSE)
...
glimpse(df1)
write.csv(df1, file="C:/Users/DELL/Documents/5530_Project-main/data_clean.csv")
