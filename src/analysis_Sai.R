...
df1 =read.csv(file="C:/Users/DELL/Documents/818_Project-main/data_clean/Accidents_Sai.csv")
...
ggsave("C:/Users/DELL/Documents/818_Project-main/results/Stacked_bar_chart.jpg")
#summarise 
 k= df1 %>%
...
ggsave("C:/Users/DELL/Documents/818_Project-main/results/dodged_bar_chart.jpg")
rm(k)
####
k= df1 %>%
  group_by(State) %>%
...
ggplot(k, aes(x = State,y = n,fill=State)) +
  ...
  labs(y="No of Accidents")+
  scale_y_continuous(trans='sqrt')
ggsave("C:/Users/DELL/Documents/818_Project-main/results//statewise_bar_chart.jpg")
rm(k)
k<- df1 %>%
  group_by(City) %>%
  summarise(n=n())
...
ggplot(data=k, aes(City,n,fill=City))+
  ...
  labs(y="No of Accidents")+
  scale_y_continuous(trans='sqrt')
ggsave("C:/Users/DELL/Documents/818_Project-main/results/Top10_cities_bar_chart_2016-21.jpg")
rm(k)
k<- df1 %>%
  group_by(Severity) %>%
  summarise(n=n())
...
ggplot(k, aes(x = "" , y = n, fill = fct_inorder(Severity))) +
  ...
  theme_void()
ggsave("C:/Users/DELL/Documents/818_Project-main/results/Severity_Pie_chart.jpg")
...
ggplot(k, aes(x = Timezone,y = n,fill=Timezone)) +
  ...
  labs(y="No of Accidents")+
  scale_y_continuous(trans='sqrt')
ggsave("C:/Users/DELL/Documents/818_Project-main/results/Timezone_bar_chart.jpg")
rm(k)
 ...
 ggsave("C:/Users/DELL/Documents/818_Project-main/results/Accidents_2021.jpg") 
 ########
test1<-df1 %>% 
   select(Year,month)%>%
   group_by(Year,month)%>%
 ...
 gg
 ggsave("C:/Users/DELL/Documents/818_Project-main/results/Accidents_Year_month.jpg")
 ...
 gg
 ggsave("C:/Users/DELL/Documents/818_Project-main/results/Accidents_Year_month2.jpg")
 ##########
 ...
 ggsave("C:/Users/DELL/Documents/818_Project-main/results/Accidents_Nov_2021.jpg")
...
df1%>% 
  ...
  labs(y="No of Accidents")+
  scale_y_continuous(trans='sqrt')
ggsave("C:/Users/DELL/Documents/818_Project-main/results/Accidents_Traffic_Sev.jpg") 
################
k1<- df1 %>%
  group_by(Year,City) %>%
  summarise(n=n())
...
gg <- gg + facet_grid(~Year)
gg
ggsave("C:/Users/DELL/Documents/818_Project-main/results/Top10_cities_2016-2021.jpg")
...
ggsave("C:/Users/DELL/Documents/818_Project-main/results/2.jpg")
...
ggplot(k1, aes(fill=Severity, y=n, x=Weather_Condition)) + 
  geom_bar(position="fill", stat="identity")
ggsave("C:/Users/DELL/Documents/818_Project-main/results/3.jpg")
